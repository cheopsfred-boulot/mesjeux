"""Fetch or import EuroMillions / My Million results."""
...
from fdj_parsers import fetch_text, parse_euromillions_result


OUTPUT = DATA_DIR / "euromillions.json"


def main() -> int:
    parser = argparse.ArgumentParser(description="Fetch EuroMillions results into data/euromillions.json")
    ...
    record = parse_euromillions_result(args.source)
    if args.raw_output:
